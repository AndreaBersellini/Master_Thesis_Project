...
class AgentQL(Agent):
    ...
    def train(self, env : 'Environment') -> None:
        ...
        for generation in range(self._generations):
            max_distances : list = [] # Maximum distances achieved in every episode of the current generation
            max_rewards : list = [] # Maximum rewards obtained in every episode of the current generation
